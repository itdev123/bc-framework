...
final class uac_roles_groups_text implements \BriskCoder\Package\Module\bcUAC\Libs\RBAC\Model\i_uac_roles_groups_text
{
    ...
    /**
     * uac_roles_groups_text TABLE SQL DELETE OPERATION
    ...
    public function delete( $_filters, $_order_by, $offset )
    {
        ...
        bcDB::mapper()->delete( $tbl->tbl_uac_roles_groups_text );
    ...
    /**
     * uac_roles_groups_text TABLE SQL READ OPERATION
    ...
    public function read( $fetchAll, $_columns, $_filters, $_order_by, $offset )
    {
        ...
        bcDB::connection( $tbl->bcDB_NS );
        bcDB::mapper()->select( $_columns, $tbl->tbl_uac_roles_groups_text );
        bcDB::mapper()->where( $_filters );
        bcDB::mapper()->orderBy( $_order_by );
        bcDB::mapper()->limit( $offset );
    ...
    /**
     * uac_roles_groups_text TABLE SQL UPDATE OPERATION
    ...
    public function update( $_columns, $_filters, $_order_by, $offset )
    {
        ...
        bcCache::deleteNamespace( $tbl->tbl_uac_roles_groups_text, TRUE );
        bcDB::connection( $tbl->bcDB_NS );
        bcDB::mapper()->update( $tbl->tbl_uac_roles_groups_text, $_columns );
        bcDB::mapper()->where( $_filters );
        bcDB::mapper()->orderBy( $_order_by );
        bcDB::mapper()->limit( $offset );
        return bcDB::mapper()->exec();
    ...
    /**
     * uac_roles_groups_text TABLE SQL WRITE OPERATION
    ...
    public function write( $_columns, $last_id )
    {
        ...
        bcCache::deleteNamespace( $tbl->tbl_uac_roles_groups_text, TRUE );
        bcDB::connection( $tbl->bcDB_NS );
        bcDB::mapper()->insert( $tbl->tbl_uac_roles_groups_text, $_columns );
