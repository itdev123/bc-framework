...
namespace BriskCoder\Package\Component\bcFormControl\Types\Select;
...
final class Validate
{
    ...
    {
        if ( ($CALLER !== 'BriskCoder\Package\Component\bcFormControl\Types\Select' ) ):
...
//returns array with all settings
     ...
     * @param String $EVENT Set javascript event to trigger validation  ie: 'focusout'|'keyupkeyup'
