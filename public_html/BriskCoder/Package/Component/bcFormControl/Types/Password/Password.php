...
use BriskCoder\bc,
    ...
    BriskCoder\Package\Component\bcFormControl\Types\Password\Events,
    BriskCoder\Package\Component\bcFormControl\Types\Password\Validate;
...
final class Password
{
     ...
     * @static $obj
     * @return \BriskCoder\Package\Component\bcFormControl\Types\Password\Events
     */
     ...
     * Requires <!--bc.head--><!--bc--> in the view page to include css and js resource or links
     * @static $obj
     * @return \BriskCoder\Package\Component\bcFormControl\Types\Password\Validate
     */
    ...
    public function getMarkup( $IDENTIFIER, $_ATTRIBUTES, $CUSTOM )
    {
        ...
        if ( !$CUSTOM ):
            ...
            bcHTML::form()->password( $_ATTRIBUTES );
