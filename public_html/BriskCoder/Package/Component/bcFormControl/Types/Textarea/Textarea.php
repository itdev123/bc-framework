...
use BriskCoder\bc,
    ...
    BriskCoder\Package\Component\bcFormControl\Types\Textarea\Events,
    BriskCoder\Package\Component\bcFormControl\Types\Textarea\Validate;
...
final class Textarea
{
     ...
     * @static $obj
     * @return \BriskCoder\Package\Component\bcFormControl\Types\Textarea\Events
     */
     ...
     * Requires <!--bc.head--><!--bc--> in the view page to include css and js resource or links
     * @static $obj
     * @return \BriskCoder\Package\Component\bcFormControl\Types\Textarea\Validate
     */
     ...
     * @param Array $_ATTRIBUTES Set attribites such as CLASS|ID|DATA-
     * @param boolean $CUSTOM Set to TRUE to use custom field instead of an input
     * @return string Html Markup
     */
    public function getMarkup( $IDENTIFIER, $VALUE, $_ATTRIBUTES, $CUSTOM )
    {
        ...
        if ( !$CUSTOM ):
            ...
            bcHTML::form()->textarea( $VALUE, $_ATTRIBUTES );
