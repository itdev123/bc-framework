...
namespace BriskCoder\Package\Module\bcUAC\Libs\Auth\Config\Types\SecurityAnswers;
...
final class Events
{
    ...
    {
        if ( ($CALLER !== ' BriskCoder\Package\Module\bcUAC\Libs\Auth\Config\Types\SecurityAnswers' ) ):
