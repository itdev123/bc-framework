...
namespace BriskCoder\Package\Component\bcFormControl\Types\Textarea;
...
final class Events
{
    ...
    {
        if ( ($CALLER !== 'BriskCoder\Package\Component\bcFormControl\Types\Textarea' ) ):
    ...
    /**
     * SET TRIGGER
     * @param String $EVENT Set javascript event to trigger events trigger ie: 'click'|'change'
